...
- `Ui/`: Discord Embed、ボタン、ページング、Autocomplete向け銘柄コード正規化、JST表示などのUI整形
...
| `DiscordBotHostedService` | HostedService。Slash Command、ボタン、Autocomplete のDiscordイベントを受け、Application Serviceと `Ui/` の表示部品を組み合わせます。 |
